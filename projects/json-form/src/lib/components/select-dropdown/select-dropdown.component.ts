import { AfterViewInit, ChangeDetectorRef, Component, ElementRef, EventEmitter, HostBinding, HostListener, Input, OnChanges, OnInit, Output, QueryList, SimpleChanges, TemplateRef, ViewChild, ViewChildren, forwardRef } from '@angular/core'
...
@Component({
  ...
  styleUrls: ['./select-dropdown.component.sass', '../../tailwind.scss'],
  providers: [
    {
